...
[TrackColor(1, 0, 0)]
[TrackClipType(typeof(TemplatePlayableAsset))]
[TrackBindingType(typeof(Light))]
[DisplayName("Templates/Template Track")]
public class TemplateTrack : TrackAsset
{
    ...
    {
        return ScriptPlayable<TemplateMixerBehaviour>.Create(graph, inputCount);
    }
